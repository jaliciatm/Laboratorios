...
**Create a workspace and Create a lakehouse with sample data** 
...
- Browse  to  and  select  these  five files: **Hospitals.csv**, **Departments.csv**, **Rooms.csv**, **Patients.csv**, **V italSignEquipment.csv** 
- Select **Open** 
...
- Configure the table: 
  - **Table  name**:  Fabric  pre-fills  this  from  the  filename  with  a lowercase  first  letter (e.g., hospitals, departments, rooms, patients, vitalSignEquip ment). 
...
| - | - | - | - |
|rooms |DepartmentId |department s |DepartmentI d |
|patients |CurrentRoomI d |rooms |RoomId |
|vitalsignequipme nt |PatientId |patients |PatientId |
...
||||
| :- | :- | :- |
|**Relationship** |**Source table** |**Source entity table: column** |
||||
||||
|rooms\_has\_departments |LamnaHealthcareLH > dbo > **Rooms** |Rooms: **RoomId** |
||||
||||
|patients\_has\_rooms |LamnaHealthcareLH > dbo > **Patients** |Patients: **PatientId** |
||||
||||
|vitalsignequipment\_has\_patients |<p>LamnaHealthcareLH > dbo </p><p>> **VitalSignEquipment** </p>|VitalSignEquipment: **Equipmen**|
||||
